...
class SelectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create selection" do
    assert_difference('Selection.count') do
      post selections_url, params: { selection: { name: @selection.name, post_image_id: @selection.post_image_id } }
    end
  ...
  test "should update selection" do
    patch selection_url(@selection), params: { selection: { name: @selection.name, post_image_id: @selection.post_image_id } }
